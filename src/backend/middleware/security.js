...
export const configureHelmet = () => helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://*.cartocdn.com", "https://*.tile.openstreetmap.org", "https://*.openstreetmap.org", "https://overpass-api.de", "https://unpkg.com", "https://cdn.jsdelivr.net", "https://server.arcgisonline.com", "https://*.arcgisonline.com", "https://fonts.googleapis.com", "https://fonts.gstatic.com", "https://accounts.google.com", "https://*.googleusercontent.com"],
